          ...
          <ProjectDetailsLinkLeftWrapper>
            ...
            >
              ...
              <div>
                ...
                <ProjectDetailsLinkText>Previous</ProjectDetailsLinkText>
              </div>
            </ProjectDetailsLink>
          </ProjectDetailsLinkLeftWrapper>
          <ProjectDetailsLinkRightWrapper>
            ...
            >
              <div style={{ textAlign: "right" }}>
                ...
                <ProjectDetailsLinkText>Next</ProjectDetailsLinkText>
              </div>
              <ImageEl style={{ marginLeft: "1rem" }} src={ChevronRight} />
            </ProjectDetailsLink>
          </ProjectDetailsLinkRightWrapper>
        </ProjectDetailsLinksWrapper>
        <HashLink className="hashlink" to={`/portfolio/#${dataProject.id}`}>
          Go back
        </HashLink>
        <HeadingSecondary
          as="h1"
